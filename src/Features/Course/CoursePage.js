            ...
            <>
                ...
                <div className="bg-OWL-base p-6 lg:px-24 overflow-hidden">
                    ...
                    <div className="flex flex-col lg:flex-row lg:gap-10">
                        ...
                        <div className="lg:flex lg:flex-col lg:justify-center gap-4 lg:w-full">
                            ...
                            <div className="mt-4 lg:text-xl">
                                <p>Jump to the recently studied</p>
                                <div className="border-2 border-gray-300 rounded-md p-2 flex gap-3 lg:p-6">
                    ...
                    <div className="mt-10 lg:mt-20">
                        ...
                        <h1 className="text-center font-bold tracking-widest text-lg lg:text-4xl">Learning Path</h1>
                    </div>
